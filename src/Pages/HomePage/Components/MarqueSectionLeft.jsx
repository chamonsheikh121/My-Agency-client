            ...
            >
                {
                    ...
                    key={i}
                    className="w-[450px] h-72 bg-white mx-4 p-6 space-y-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out flex items-start flex-col  justify-center">
                        {/* Profile Section */}
                        <img
